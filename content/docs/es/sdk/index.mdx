...
<Cards>
  <Card title="SDK Node.js" href="/docs/sdk/backend/node" description="Triggers, schedules, HMAC — solo servidor." />
  <Card title="SDK React" href="/docs/sdk/frontend/react" description="Campana, inbox, preferencias — UI en browser." />
