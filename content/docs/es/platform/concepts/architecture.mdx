...
<Callout type="idea">
Development usa **modo sandbox** — los canales externos se simulan para que pruebes sin gasto en proveedores. Consulta [Sandbox](/docs/platform/features/sandbox).
</Callout>
