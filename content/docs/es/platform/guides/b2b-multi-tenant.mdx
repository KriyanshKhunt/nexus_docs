...
<Steps>
  ...
  <Step>Sube los recursos de marca a un CDN HTTPS de acceso público. Nexus no aloja imágenes.</Step>
  <Step>Añade el campo `tenant` en cada trigger disparado para los usuarios de esa empresa.</Step>
  <Step>Prueba con dos tenants en Desarrollo antes de salir a producción en Production.</Step>
</Steps>
