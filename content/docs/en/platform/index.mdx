...
<Cards>
  ...
  <Card title="Features" href="/docs/platform/features" description="Objects, broadcasts, AI nodes, guides, and more." />
  <Card title="Integrations" href="/docs/platform/integrations" description="SendGrid, Twilio, Slack, webhooks." />
  <Card title="Guides" href="/docs/platform/guides" description="Workflows, fan-out, broadcasts, multi-tenant." />
</Cards>
...
| **Visual workflows** | Delay, digest, throttle, failover, A/B split, HTTP Fetch, AI nodes |
| **Object fan-out** | Notify all subscribers of a project/issue with one trigger |
| **Broadcasts & guides** | PM-driven announcements and in-product messaging |
| **CLI + MCP** | Version-control workflows, AI assistant integration |
...
| Notify all watchers of an entity | [Object fan-out guide](/docs/platform/guides/object-fanout) |
| Send product announcement | [First broadcast](/docs/platform/guides/first-broadcast) |
| White-label per customer | [B2B multi-tenant](/docs/platform/guides/b2b-multi-tenant) |
