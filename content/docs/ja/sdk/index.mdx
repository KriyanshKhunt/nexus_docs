...
<Cards>
  <Card title="Node.js SDK" href="/docs/sdk/backend/node" description="トリガー、スケジュール、HMAC — サーバーサイド専用。" />
  <Card title="React SDK" href="/docs/sdk/frontend/react" description="ベル、受信箱、設定 — ブラウザ UI。" />
