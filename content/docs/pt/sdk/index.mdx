...
<Cards>
  <Card title="Node.js SDK" href="/docs/sdk/backend/node" description="Gatilhos, agendamentos, HMAC — apenas no servidor." />
  <Card title="React SDK" href="/docs/sdk/frontend/react" description="Sino, inbox, preferências — interface do navegador." />
