...
## Passo 2 — Escrever os Modelos (Templates)
...
## Passo 3 — Criar um Inscrito de Teste
...
## Passo 4 — Disparar a partir do seu Backend
...
## Passo 5 — Adicionar o Sino In-App ao seu Frontend
